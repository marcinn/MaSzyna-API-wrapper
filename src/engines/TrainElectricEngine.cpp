...
namespace godot {
    ...
    void TrainElectricEngine::_do_fetch_state_from_mover(TMoverParameters *mover, Dictionary &state) {
        ...
        state["accumulator/recharge_source"] = static_cast<int>(mover->EnginePowerSource.RAccumulator.RechargeSource);
        ...
        state["power_cable/source"] = static_cast<int>(mover->EnginePowerSource.RPowerCable.PowerTrans);
    ...
    void TrainElectricEngine::_do_update_internal_mover(TMoverParameters *mover) {
        ...
        switch (static_cast<TPowerSource>(power_source)) {
            ...
            case TPowerSource::PowerCable: {
                mover->EnginePowerSource.RPowerCable.PowerTrans = static_cast<TPowerType>(power_cable_power_trans);
    ...
    void TrainElectricEngine::set_accumulator_recharge_source(const int p_source) {
        accumulator_recharge_source = p_source;
        _dirty = true;
    }

    int TrainElectricEngine::get_accumulator_recharge_source() const {
        return accumulator_recharge_source;
    }

    void TrainElectricEngine::set_power_cable_power_source(const int p_source) {
        power_cable_power_trans = p_source;
        _dirty = true;
    }

    int TrainElectricEngine::get_power_cable_power_source() const {
