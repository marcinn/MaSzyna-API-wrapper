...
namespace godot {
    ...
    void TrainDoors::_bind_methods() {
        ...
        ClassDB::bind_method(D_METHOD("set_lock_doors", "state"), &TrainDoors::set_lock_doors);
        ClassDB::bind_method(D_METHOD("set_remote_only", "state"), &TrainDoors::set_remote_only);
    ...
    void TrainDoors::_register_commands() {
        ...
        register_command("doors_remote_only", Callable(this, "set_remote_only"));
    }
    ...
    void TrainDoors::_unregister_commands() {
        ...
        unregister_command("doors_remote_only", Callable(this, "set_remote_only"));
    }
    ...
    void TrainDoors::set_lock_doors(const bool p_state) {
        TMoverParameters *mover = get_mover();
        ASSERT_MOVER(mover);
        mover->LockDoors(p_state);
    }

    void TrainDoors::set_remote_only(const bool p_state) {
        TMoverParameters *mover = get_mover();
        ASSERT_MOVER(mover);
